...
export const fnGetCharacters = async (req, res) => {
  try {
    const str_characterName = req.params.name;
    // 캐릭터 이름이 없을 경우
    ...
    // 5. 최종 응답
    return res.status(400).json({ characterName: str_characterName, data: character });
  } catch (error) {
